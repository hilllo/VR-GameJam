...
public class h_WandController : MonoBehaviour {
    ...
    /// </summary>
    private HashSet<h_InteractableObject> _ObjectsHoveringOver = new HashSet<h_InteractableObject>();

    /// <summary>
    /// The Ojbect that is the closest can be interacting.
    /// </summary>
    private h_InteractableObject _ClosestObject;
    private h_InteractableObject _InteractingObject;
